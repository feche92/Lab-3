...
window.onload = function () {
    $.ajax({
        ...
        if (resultado.mensaje == 'token valido') {
            ...
            var lista = "<table class='table table-dark'><thead><tr><th scope='col'>CORREO</th><th scope='col'>NOMBRE</th><th scope='col'>APELLIDO</th><th scope='col'>PERFIL</th><th scope='col'>LEGAJO</th><th scope='col'>FOTO</th></tr></thead>";
            lista += "<tbody>";
...
function ModificarPersona(item) {
    var modal = "<div id='myModal' class='modal fade' role='dialog'>";
    modal += "<div class='modal-dialog'>";
    modal += "<div class='modal-content'>";
...
function GuardarCambios() {
    var usuario = JSON.parse(String(localStorage.getItem("usuarioIngresado")));
    var fuente = $("#fuente").val();
    var fondo = $("#fondo").val();
    var forma = $("#forma").val();
    var json = '{"fondo":"' + fondo + '","fuente":"' + fuente + '","forma":"' + forma + '"}';
